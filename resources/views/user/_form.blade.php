                ...
                <div class="portlet-body form">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1_1">
                            {!! Form::model($user, ['id'=> 'myForm', 'url' => 'user/store', 'enctype' => 'multipart/form-data', 'role' => 'form']) !!}
                            {!! Form::hidden('id_user') !!}
                            @if (Auth::user()->id_client == 1)
                                <div class="form-group form-md-line-input has-success">
                                    {!! Form::label('id_client', __('messages.siaf_user-id_client'), ['class' => 'control-label']) !!}
                                    {!! Form::select('id_client', $clients, null, ['class' => 'form-control', 'placeholder' => __('messages.siaf_user-id_client')]) !!}
                                </div>
                            @endif

                            <div class="form-group form-md-line-input has-success">
                                {!! Form::label('id_profile', __('messages.siaf_user-id_profile'), ['class' => 'control-label']) !!}
                                {!! Form::select('id_profile', $profiles, null, ['class' => 'form-control', 'placeholder' => __('messages.siaf_user-id_profile')]) !!}
                            </div>

                            <div class="form-group form-md-line-input has-success">
                                {!! Form::label('name', __('messages.siaf_user-name'), ['class' => 'control-label']) !!}
                                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('messages.siaf_user-name')]) !!}
                            </div>
                            <div class="form-group form-md-line-input has-success">
                                {!! Form::label('login', __('messages.siaf_user-login'), ['class' => 'control-label']) !!}
                                {!! Form::text('login', null, ['class' => 'form-control', 'placeholder' => __('messages.siaf_user-login')]) !!}
                            </div>
                            <div class="form-group form-md-line-input has-success">
                            ...
                            <div class="form-group form-md-line-input has-success">
                                {!! Form::label('ind_st_user', __('messages.siaf_user-ind_st_user'), ['class' => 'control-label']) !!}
                                {!! Form::select('ind_st_user', $indStUser, null, ['class' => 'form-control']) !!}
                            </div>
