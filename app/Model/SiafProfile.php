...
class SiafProfile extends SiafModel
{
    ...
    public function rules(){
        return [
            'name_profile' => 'required|min:3|max:100|unique:siaf_profile,name' .
    ...
    public function users(){
        return $this->hasMany('App\Model\SiafUser','id_profile','id_profile');
    }
    ...
    public function rules_(){
        return $this->belongsToMany('App\Model\SiafRule',  'siaf_profile_rule', 'id_profile', 'id_rule');
    }
}
