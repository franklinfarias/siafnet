@extends('layouts.app')
@section('subtitle',__('messages.siaf_member-model-subtitle-create'))
@section('content')
        ...
        <div class="container">
            ...
            <div class="page-title">
                <h1>@lang('messages.siaf_member-model-name')
                    <small>@lang('messages.siaf_member-model-subtitle-create')</small>
                </h1>
            </div>
            <!-- END PAGE TITLE -->
            <!-- BEGIN PAGE TOOLBAR -->
            <div class="page-toolbar">
                <div class="btn-group btn-theme-panel">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        <li>
                            <a href="{{URL::to('member/list')}}">@lang('messages.siaf_member-breadcrumb')</a>
