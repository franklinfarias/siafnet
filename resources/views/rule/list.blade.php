@extends('layouts.app')
@section('subtitle',__('messages.siaf_rule-model-subtitle-list'))
@section('content')
    ...
    <div class="container">
        ...
        <div class="page-title">
            <h1>@lang('messages.siaf_rule-model-name')
                <small>@lang('messages.siaf_rule-model-subtitle-list')</small>
            </h1>
        </div>
        <!-- END PAGE TITLE -->
        <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                <tr>
                                    <th>@lang('messages.siaf_rule-name_rule')</th>
                                    <th>@lang('messages.siaf_rule-key')</th>
                                    <th>@lang('messages.siaf_rule-created_at')</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('rule/edit/'.$rule->id_rule)}}" class="edit" data-toggle="tooltip" title="@lang('messages.edit')"><i class="fa fa-pencil"></i></a>
                                        <a href="javascript:confirmDelete('{{url('rule/delete/'.$rule->id_rule)}}','{{csrf_token()}}');" class="delete" data-toggle="tooltip" title="@lang('messages.delete')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
