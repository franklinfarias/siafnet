...
class SiafNotification extends SiafModel
{
    protected $table = 'siaf_notification';
    ...
    public function userOrigin(){
        return $this->hasOne('App\Model\SiafUser','id_user','id_user_origin');
    }
    /**
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne
    ...
    public function userDestiny(){
        return $this->hasOne('App\Model\SiafUser','id_user','id_user_destiny');
    }
