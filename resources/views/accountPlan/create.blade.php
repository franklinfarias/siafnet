@extends('layouts.app')
@section('subtitle',__('messages.siaf_account_plan-model-subtitle-create'))
@section('content')
    ...
    <div class="container">
        ...
        <div class="page-title">
            <h1>@lang('messages.siaf_account_plan-model-name')
                <small>@lang('messages.siaf_account_plan-model-subtitle-create')</small>
            </h1>
        </div>
        <!-- END PAGE TITLE -->
        <!-- BEGIN PAGE TOOLBAR -->
